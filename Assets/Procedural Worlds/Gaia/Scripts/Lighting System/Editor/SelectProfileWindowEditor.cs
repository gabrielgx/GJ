    ...
    public class SelectProfileWindowEditor : EditorWindow
    {
        ...
        private void Water()
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                GaiaWater.GetProfile(m_gaiaSettings.m_gaiaWaterProfile.m_selectedWaterProfileValuesIndex, waterMat, m_waterProfile, m_gaiaSettings.m_pipelineProfile.m_activePipelineInstalled, true, false);
            }
        }
