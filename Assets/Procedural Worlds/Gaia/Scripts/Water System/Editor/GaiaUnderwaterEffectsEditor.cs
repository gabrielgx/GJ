...
namespace Gaia
{
    ...
    public class GaiaUnderwaterEffectsEditor : PWEditor
    {
        ...
        private void GlobalSettings(bool helpEnabled)
        {
            ...
            m_profile.m_underwaterParticles = (GameObject)m_editorUtils.ObjectField("UnderwaterParticles", m_profile.m_underwaterParticles, typeof(GameObject), helpEnabled);
            m_profile.m_horizonObject = (GameObject)m_editorUtils.ObjectField("HorizonObject", m_profile.m_horizonObject, typeof(GameObject), helpEnabled);
