...
namespace Gaia
{
    ...
    class Gaia2TopPanel
    {
        ...
        public static void RenderSceneGUI(SceneView sceneview)
        {
            ...
            Handles.BeginGUI();
            if (GaiaTerrainLoaderManager.Instance.TerrainSceneStorage.m_hasWorldMap)
            {
                DrawTopPanel();
            }
        ...
        private static void DrawTopPanel()
        {
            ...
            float sizeX = GaiaSettings.m_gaiaPanelSizeType == HeightMaskType.Relative ? scaledScreenWidth * GaiaSettings.m_gaiaPanelSize.x / 100f : GaiaSettings.m_gaiaPanelSize.x;
            float sizeY = GaiaSettings.m_gaiaPanelSizeType == HeightMaskType.Relative ? scaledScreenHeight * GaiaSettings.m_gaiaPanelSize.y / 100f : GaiaSettings.m_gaiaPanelSize.y;
            float x = GaiaSettings.m_gaiaPanelPositionType == HeightMaskType.Relative ? (scaledScreenWidth * GaiaSettings.m_gaiaPanelPosition.x / 100f) - (sizeX + 50f) / 2f : GaiaSettings.m_gaiaPanelPosition.x;
            float y = GaiaSettings.m_gaiaPanelPositionType == HeightMaskType.Relative ? (scaledScreenHeight * GaiaSettings.m_gaiaPanelPosition.y / 100f) : GaiaSettings.m_gaiaPanelPosition.y;
