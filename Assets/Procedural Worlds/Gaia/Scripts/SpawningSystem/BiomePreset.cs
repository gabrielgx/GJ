    ...
    public class BiomePreset : ScriptableObject
    {
        ...
        public void RefreshSpawnerListEntries()
        {
            ...
            foreach (BiomeSpawnerListEntry bsle in m_spawnerPresetList)
            {
                ...
                {
                    if (!string.IsNullOrEmpty(bsle.m_spawnerSettings.lastSavePath))
                    {
                        SpawnerSettings spawnerSettings = (SpawnerSettings)AssetDatabase.LoadAssetAtPath(bsle.m_spawnerSettings.lastSavePath, typeof(SpawnerSettings));
