...
namespace Gaia
{
    ...
    public class WorldMapStampToken : MonoBehaviour
    {
        ...
        public void SyncLocationFromStamperSettings()
        {
            ...
            float relativeX = (float)(m_connectedStamperSettings.m_x - b.min.x + origin.x / GaiaTerrainLoaderManager.Instance.TerrainSceneStorage.m_worldMaprelativeSize) / (float)b.size.x;
            float relativeY = (float)m_connectedStamperSettings.m_y * GaiaTerrainLoaderManager.Instance.TerrainSceneStorage.m_worldMaprelativeSize;
            float relativeZ = (float)(m_connectedStamperSettings.m_z - b.min.z + origin.z / GaiaTerrainLoaderManager.Instance.TerrainSceneStorage.m_worldMaprelativeSize) / (float)b.size.z;
        ...
        public void SyncWorldMapStamper()
        {
            if (m_syncedWorldMapStamper != null)
            {
                ...
                m_syncedWorldMapStamper.m_settings.m_width = m_connectedStamperSettings.m_width / GaiaTerrainLoaderManager.Instance.TerrainSceneStorage.m_terrainTilesX; 
        ...
        private Vector3 GetLocalStamperPosition()
        {
            ...
            float relativeY = transform.position.y / GaiaTerrainLoaderManager.Instance.TerrainSceneStorage.m_worldMaprelativeSize; 
