...
namespace Gaia
{
    ...
    //    {
    //        return PWCommon2.Utils.FixFileName(sessionName) + "_" + Path.GetFileName(m_fileName);
    //    }
    ...
    //    {
    //        return PWCommon2.Utils.FixFileName(sessionName) + "_" + Path.GetFileName(soFileName);
    //    }
    ...
    public class GaiaSession : ScriptableObject
    {
        ...
        {
            return PWCommon2.Utils.FixFileName(m_name);
        }
