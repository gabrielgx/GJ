...
namespace Gaia
{
    ...
    ///// </summary>
    public enum ProgressBarPriority { TerrainLoading, MinMaxHeightCalculation, CreateBiomeTools, CreateSceneTools, BiomeRemoval, MultiTerrainAction, MaskMapExport, Stamping, Spawning, WorldCreation, Maintenance };
