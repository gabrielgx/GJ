...
{
    public enum GaiaPackageVersion { Unity2019_1, Unity2019_2, Unity2019_3, Unity2019_4 }
    ...
    public class UnityPipelineProfile : ScriptableObject
    {
        ...
        [Header("Pipeline Supported Versions 2019.4")]
        [HideInInspector]
        public string m_min2019_4HDVersion = "5.7.2";
        [HideInInspector]
        public string m_max2019_4HDVersion = "5.13.0";
        [HideInInspector]
        public string m_min2019_4UPVersion = "5.7.2";
        [HideInInspector]
        public string m_max2019_4UPVersion = "5.13.0";
