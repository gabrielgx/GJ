...
namespace Gaia.GX.ProceduralWorlds
{
    public class CTSGX
    {
        ...
        {
            AddCTSProfile("CTS Alpine Meadow");
        }
        public static void GX_AddColorfulForestProfile()
        {
            AddCTSProfile("CTS Colorful Forest");
        }
        public static void GX_AddConiferousForestProfile()
        {
            AddCTSProfile("CTS Coniferous Forest");
        }
        public static void GX_AddDeciduousForestProfile()
        {
            AddCTSProfile("CTS Deciduous Forest");
        }
        public static void GX_AddGiantForestProfile()
        {
            AddCTSProfile("CTS Giant Forest");
        }
        public static void GX_AddMixedForestProfile()
        {
            AddCTSProfile("CTS Mixed Forest");
        }
        public static void GX_AddRedwoodForestProfile()
        {
            AddCTSProfile("CTS Redwood Forest");
        }
#endif

        public static void GX_AddGaiaProSampleProfile()
        {
            AddCTSProfile("CTS Gaia Pro Sample");
        }
        public static void GX_AddSyntyStudiosProfile()
        {
            AddCTSProfile("CTS Synty Studios");
        }
        ...
        private static void AddCTSProfile(string profileName)
        {
        ...
        {
            string[] assets = AssetDatabase.FindAssets(name + " t:CTSProfile", null);
            if (assets != null)
            {
