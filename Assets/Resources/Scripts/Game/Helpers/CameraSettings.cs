...
namespace Gamekit3D
{
    public class CameraSettings : MonoBehaviour
    {
        ...
        void UpdateCameraSettings()
        {
            ...
            aimCamera.m_XAxis.m_InvertInput = controllerInvertSettings.invertX;
            aimCamera.m_YAxis.m_InvertInput = controllerInvertSettings.invertY;
            aimCamera.Follow = follow;
