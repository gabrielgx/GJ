...
namespace Gamekit3D
{
    ...
    public class PlayerController : MonoBehaviour, IMessageReceiver
    {
        ...
        void FixedUpdate()
        {
            ...
            if (m_Input.Ability2 && m_Input.Aim)
        ...
        bool IsWeaponEquiped()
        {
            ...
            equipped |= m_NextStateInfo.shortNameHash == m_HashEllenDash || m_CurrentStateInfo.shortNameHash == m_HashEllenDash;
