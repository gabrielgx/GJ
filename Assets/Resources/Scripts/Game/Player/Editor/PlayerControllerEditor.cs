...
namespace Gamekit3D
{
    ...
    public class PlayerControllerEditor : Editor
    {
        ...
        SerializedProperty m_GameCameraProp;
        SerializedProperty m_AimCameraProp;
        SerializedProperty m_AimRigProp;
        SerializedProperty m_ShootRigProp;
        SerializedProperty m_HeadTarget;
        SerializedProperty m_GunRenderer;
        ...
        GUIContent m_GameCameraContent = new GUIContent("Game Camera", "Used to get the rotation of the current camera so that Ellen faces the correct direction.  Note: This is the only reference which is not part of the Ellen prefab.  It should automatically be set to the Camera Settings script of the CameraRig gameobject when the Prefab is instantiated.");
        GUIContent m_AimCameraContent = new GUIContent("Aim Camera");
        GUIContent m_AimRigContent = new GUIContent("Aim Rig");
        GUIContent m_ShootRigContent = new GUIContent("Shoot Rig");
        GUIContent m_GunRendererContent = new GUIContent("Gun Renderer");
        ...
        void OnEnable()
        {
            ...
            m_AimRigProp = serializedObject.FindProperty("aimRig");
            m_ShootRigProp = serializedObject.FindProperty("shootRig");
            m_HeadTarget = serializedObject.FindProperty("headTarget");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_MeleeWeaponProp.isExpanded)
            {
                ...
                EditorGUILayout.PropertyField(m_GameCameraProp, m_GameCameraContent);
